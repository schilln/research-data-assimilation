...
\begin{frame}
    ...
    \begin{align*}
        ...
        &F: \R^n \times \R^p \rightarrow \R^n &&\text{function defining true differential equation} \\
...
\begin{frame}
    ...
    \end{equation}
    \begin{align*}
        &G: \R^n \times \R^{\textcolor{red}q} \rightarrow \R^n &&\text{function defining estimated differential equation} \\
